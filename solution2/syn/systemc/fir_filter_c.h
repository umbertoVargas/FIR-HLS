...
// ==============================================================
#ifndef __fir_filter_c_H__
#define __fir_filter_c_H__
...
struct fir_filter_c_ram : public sc_core::sc_module {
...
fir_filter_c_ram* meminst;


SC_CTOR(fir_filter_c) {
meminst = new fir_filter_c_ram("fir_filter_c_ram");
